jQuery( document ).ready( function() {
	...
	wp.customize(
		'vw_medical_care_p_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_a_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h1_font_family',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h1_font_weight',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h1_line_height',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h1_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h2_font_family',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h2_font_weight',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h2_line_height',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h2_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h3_font_family',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h3_font_weight',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h3_line_height',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h3_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h4_font_family',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h4_font_weight',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_vw_medical_care_h4_font_size',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_vw_medical_care_h4_line_height',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_vw_medical_care_h4_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_vw_medical_care_h5_font_color',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_vw_medical_care_h5_font_family',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h5_font_weight',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h5_line_height',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h5_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h6_font_family',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h6_font_weight',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h6_line_height',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'vw_medical_care_h6_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
